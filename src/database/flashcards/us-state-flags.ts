...
export const us_state_flags: FlashCard[] = [
	{
		questionTitleHtml: '<strong>US State Flag</strong>',
	...
	},
	{
		...
		censorBlocks: [
			...
			{ top: '41%', left: '58%', width: '7%', height: '28%' }, // "HAMPSHIRE" text
		],
	},
	{
		questionTitleHtml: '<strong>US State Flag</strong>',
	...
	},
	{
		...
		censorBlocks: [
			...
			{ top: '32%', left: '55%', width: '6%', height: '13%' }, // "SOUTH DAKOTA" text
		],
	},
	{
		questionTitleHtml: '<strong>US State Flag</strong>',
